...
class IntakeTalon_FX(commands2.Subsystem):
    """
    ...
    def __init__(self):
        ...
        # self.uMotor.setNeutralMode(NeutralMode(2))
        # self.lMotor.setNeutralMode(NeutralMode(2))
    ...
    def periodic(self) -> None:
        ...
        # SmartDashboard.putBoolean("ir recieving", self.frontIR.get())
        # SmartDashboard.putBoolean("emitter current output", self.getBackIR())

        # self.IREmitter.set(1)
