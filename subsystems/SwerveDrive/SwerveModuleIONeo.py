...
class SwerveModuleIONeo(SwerveModuleIO):
    ...
    def __init__(self, subsystemName:str, driveId:int, turnId:int, sensorId:int, posX:float, posY:float, turnOffset:float):
        ...
        self.turnMotor.enableVoltageCompensation( 10.00  )
        self.turnMotor.setSmartCurrentLimit( 30, 30 )
        ...
        self.driveMotor.enableVoltageCompensation( 11.75 )
        self.driveMotor.setSmartCurrentLimit( 30, 30 )
