...
class LauncherIOFalcon(LauncherIO):
    def __init__( self, leftCanId:int, rightCanId:int, sensorId:int ):
        ...
        self.rightMotor.setInverted( leftInvert.get() )
    ...
    def resetPid(self):
        self.leftMotor.config_kP( self.launcher_kP.get(), 0 )
        self.leftMotor.config_kI( self.launcher_kI.get(), 0 )
        self.leftMotor.config_kD( self.launcher_kD.get(), 0 )
        self.leftMotor.config_kF( self.launcher_kF.get(), 0 )
        self.leftMotor.config_IntegralZone( self.launcher_Iz.get(), 0 )

        self.rightMotor.config_kP( self.launcher_kP.get(), 0 )
        self.rightMotor.config_kI( self.launcher_kI.get(), 0 )
        self.rightMotor.config_kD( self.launcher_kD.get(), 0 )
        self.rightMotor.config_kF( self.launcher_kF.get(), 0 )
        self.rightMotor.config_IntegralZone( self.launcher_Iz.get(), 0 )
